...
@section('content')
  <div class="bg-gray-900 px-20 py-16 rounded-r-lg mb-8 relative overflow-hidden">
    <span class="text-xs uppercase text-gray-700 bg-gray-400 px-2 rounded-full py-1">Programacion</span>
    ...
    <img src="{{ asset('images/dev.png') }}" class="absolute right-8 bottom-10 opacity-20 h-80" alt="dev">
  </div>
    ...
    <div class="grid grid-cols-1 gap-4 mb-4">
      @foreach($posts as $post)
        <a href="{{ route('post', $post->slug) }}" class="bg-gray-100 rounded-lg px-6 py-4">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="h4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
